...
public class GameEndScreen {
     ...
     * The final score is calculated based on remaining time and points gained if the game was won.
     * If the game was lost, the final score is set to 0.
     *
    ...
    public void setFinalScore(double timeRemaining, double gainedScore) {
        // If the game was lost, set final score to 0
        if (!isWon) {
            this.finalScore = 0.0;
        } else {
