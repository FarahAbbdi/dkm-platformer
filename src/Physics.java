...
public class Physics {
    ...
    /**
     * The gravitational acceleration applied to normal monkeys.
     */
    public static final double NORMAL_MONKEY_GRAVITY = 0.3;

    /**
     * The gravitational acceleration applied to intelligent monkeys.
     */
    public static final double INTEL_MONKEY_GRAVITY = 0.3;
    ...
    /**
     * The maximum falling speed (terminal velocity) for normal monkeys.
     */
    public static final double NORMAL_MONKEY_TERMINAL_VELOCITY = 5.0;

    /**
     * The maximum falling speed (terminal velocity) for intelligent monkeys.
     */
    public static final double INTEL_MONKEY_TERMINAL_VELOCITY = 5.0;
}